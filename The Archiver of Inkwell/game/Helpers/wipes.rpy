init:
    ...
    $ curtains = ImageDissolve("wipes/curtains.png", 1.0, 8)

    $ snow1 = ImageDissolve("wipes/snow1.png", 1.0, 8)
    $ rain1 = ImageDissolve("wipes/rain1.jpg", 1.0, 8)
    $ rain2 = ImageDissolve("wipes/rain2.jpg", 1.0, 8)
    ...
    $ w34 = ImageDissolve("wipes/34.png", 1.0, 8)
    $ w35 = ImageDissolve("wipes/35.jpg", 1.0, 8)
    $ w36 = ImageDissolve("wipes/36.jpg", 1.0, 8)
    $ w37 = ImageDissolve("wipes/37.png", 1.0, 8)
