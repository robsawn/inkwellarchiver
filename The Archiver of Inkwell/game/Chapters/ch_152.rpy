label ch_152:
    scene bg culthall
    play music "audio/4 Lovecraftian/5B (Bad End)/1 Getting Caught At Ritual Site L.ogg" loop fadein 1.0
    ...
    scene bg underhall with dissolve_fast
    ...
    play sound "audio/sfx/Rook_s gunshot.ogg" volume 0.65
    ...
    show shiori mad at right zorder -1
    ...
    show shiori sad with moveoutright
    show shiori sad at left with moveinleft
    ...
    play music "audio/4 Lovecraftian/5B (Bad End)/2 Ritual Sacrifice Scene L.ogg" loop fadein 0.5
    play ambient "audio/Ambient/1 Subtrack L.ogg" loop fadein 0.5

    "Taking a few breaths, they speak in a soft, yet affirming voice. While quiet, it feels as though they are addressing each one of us. The world, brought to its knees, fell silent, waiting for the leader's words."

    hide shiori frown with dissolve_fast
    ...
    show shiori frown at left with dissolve_fast
    ...
    show shiori neutral at left with dissolve_slow
    ...
    show bg exitsplotch2 with fade
    ...
    show shiori sad at center with MoveTransition(1.0)
    ...
    play sound "audio/sfx/Rook_s gunshot.ogg" volume 0.5
