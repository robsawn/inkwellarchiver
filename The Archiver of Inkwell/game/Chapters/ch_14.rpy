label ch_14:
    ...
    play music "audio/4 Lovecraftian/4B/2 For Wandering The Desolate Streets L.ogg" loop fadein 0.75
    play nature "audio/Ambient/rain4.ogg"

    show rainbackheavy zorder 5
    show rainmidheavy zorder 15
    show rainfront onlayer front 

    "The rain hasn't let up since the day Shiori vanished and the campus is unsurprisingly scarce. Most students and even faculty just haven't shown up." 
    
    "Just making my way around on a day like this has become a maddening process of trudging through ankle high puddles as the older streets overflow. If I wasn't trying to find someone, I wouldn't have bothered showing up either."

    "Even so, she's worth it, isn't she? Making sure she's ok? Things have gone too far to be just a coincidence, right? Perhaps it's a prank by those 'trendy' 'cultists'? But what if it's more than that?"
    ...
    if followcultists:
        ...
        "They haven't noticed me yet, but I can't just sit around and wait until they do! I dive behind the closest hiding spot I can find. A trashcan might not be ideal, but it will do in a pinch." 
        
        "While at first glance they all seem content with standing about menacingly with that all too familiar vacant stare, after a while, I manage to catch them talking. Initially it just sounds like muttering, so I take my chances and move a little closer."
        ...
        "Wait? Shiori was right?! The conversation went from 0 to 100 faster than I could process, with rituals, contingency plans, and even just how they view Shiori. They're really a cult?!" 
        
        "In a flash, the whole world spins around me. Partly due to the revelations, yes, but I had also failed to notice the frustrated cultist taking their anger out on a can, kicking it in my direction."
        ...
        stop music fadeout 0.5
        play music "audio/4 Lovecraftian/4B/1 When the City-Story is Unraveling L.ogg" loop fadein 0.75
        ...
        "My attention is drawn to the book Shiori gave me as serendipity compels me to open it. Huh." 
        
        "It's mostly full of scribbles that are difficult to read, but I can make out details about a cult of the 'Void Wyrm'. There are numerous doodles of their symbol, as well as something about a ritual to call the creature into our world."
        ...
        p_i "Take? Alive? I don't like where this conversation is going, and I'm not going to stick around for the rest of it."
    ...
    if followcats:
        ...
        "Despite the fact that the rain is constant, the local cat population has never been too keen on it. Of course that makes it difficult to find them, because the strays are never out in the open." 
        
        "I had picked something up to help lure them out but it was to no avail. So I begin my search looking through bushes, under awnings, and trees, any place a cat could stay dry, really."

        play sound "audio/sfx/purr.ogg" fadein 1.0
        cat "Mroooooow~"
        ...
        show bg garden with dissolve_slow
        ...
        "I take a seat on the bench, the cats mildly protesting this as an act of sacrilege. Leave it to Shiori to find the perfect spot on campus for reading." 
        
        "The leaves of the tree are soaked through and provide little protection, but propping up my umbrella is an easy fix."

        p_i "So this is the book Shiori felt was so important...?"

        stop music fadeout 0.5
        play music "audio/4 Lovecraftian/3B/2 Cult Lore Dump, Unveiling Mystery Track L.ogg" loop fadein 0.65

        "Admittedly I had gotten curious and tried peeking at the book before, but it was mostly unintelligible scribbles until now. The cypher reveals an obtuse yet flowery prose full of vignettes and 'first hand accounts'." 
        
        "All of them seem to involve a cult and a 'creature beyond mind or matter' that they worship, known as the Void Wyrm."

        p_i "Is this what Shiori thinks that clique is about? Do they really believe in this thing?"

        "It reads like a sci-fi anthology with a large chunk of the pages being just blank. Still there is some consistency across all of the stories and the descriptions of the town itself are fairly spot on." 
        
        "It even mentions parts of the campus I've been to, and the cafe where I met Shiori."
        ...
        show rainbacklight zorder 6
        show rainmidlight zorder 14
        play ambient "audio/Ambient/rain4.ogg" fadein 1.0 loop
        ...
        "After a couple hours of walking around, 'appreciating the town's abundance of Victorian architecture', out of the corner of my eye, I start to see more of those flowers." 
        
        "For a moment, they blink and move like an old rubber hose animation before sinking into the earth without a trace."

        p "I'm starting to think these might be... No. That would be absurd. Unless…"

        scene bg compound with fade

        "As I make my way over to investigate where I saw flowers, a manor across the street catches my eye. It's old, but not worn down, like it's been renovated a few times." 
        
        "It could easily be an upscale club or lodge of some sort. Or... Even a meeting place for a cult."
        ...
        "It doesn't take long before my suspicions are confirmed. A good 20 minutes is all it takes for a couple of the raincoated cultists to walk up to the building in question." 
        
        "They give a brief rhythmic knock before they are welcomed in by another of their clique."

        p_i "This is it! This must be the place where they have Shiori! I can't believe I figured it out! But, now what?"

        "Frankly, I hadn't thought too hard about this part. They probably won't let me in to see Shiori if I ask nicely." 
        
        "If the book's contents are to be taken seriously, that might even get me stabbed. But I also can't hide out here for too long. They could notice me."
        ...
        "The hinges creak as I pry the door open slowly, trying to keep the noise to a minimum. I manage to slip in and carefully close it behind me." 
        ...
        "Almost immediately lavish furnishings and the distant hymn of classical music shift the atmosphere from dreary to invitingly decadent." 

        "While there is no one in my immediate vicinity, I can hear the murmur of voices from every which way." 
        
        "There isn't much time, so I rummage through the room I made it into, grabbing journals, pamphlets, letters, and whatever small odds and ends might go unnoticed."

        p_i "My first B&E, mom would be {b}so{/b} proud."
        ...
        play music "audio/4 Lovecraftian/3B/2 Cult Lore Dump, Unveiling Mystery Track L.ogg" loop fadein 1.5
        show bg cafe with Fade(1.5,2.0,1.5)
        ...
        "It's all here, the raincoats, the Void Wyrm, the secret knocks and handshakes. There is even something written about Shiori here. I think." 
        
        "They keep referring to her as The Archiver, and it's written like they've been trying to get their hands on her for decades."

        p_i "She can't be that old. She literally can't be. ...These letters are, though."

        "My attention is drawn to the book Shiori gave me as serendipity compels me to open it. I wanted to compare notes but the comparison has been made for me already." 
        
        "All of the various details I found through my investigation are now filling pages of the book which were blank before."

        p "What is this? This can't be real..." 

    stop music fadeout 0.25
    play music "audio/4 Lovecraftian/3B/3 Shiori Missing Track L.ogg" loop fadein 0.75
    
    "It has been an overwhelming day to say the least. I feel like I barely made it out in one piece. The cult is a 'thing' and they mean business. There's just too much to ignore." 
    
    "Not to mention they definitely have Shiori. Yet I'm almost ashamed to say that my batteries are drained. It might be best to call it a night and regroup after getting some rest."
    ...
    if getrest:
        ...
        "It is oddly quiet as I make my way back to the dorms. It's peaceful, even. As I drift off to sleep, however, I'm hounded by bizarre dreams of abstract concepts and choices I could have made." 
        
        "In the haze of it all, I find myself wondering: What if I had gone with Shiori? Would the cult still have her? Or would I just be locked away somewhere too?"

        "It isn't exactly a full eight hours, but I find myself waking restlessly around the crack of dawn. With a yawn I decide that for whatever sleep I'm lacking, coffee can make the difference." 
        
        "I rush right back out the door, hoping to pick some up at the cafe."
    ...
    if exhaustion:
        ...
        "I start the night off meandering around town, taking notes of whatever cultists I spot and what they are doing. Most are just standing around or moving around in simple patterns." 
        
        "For the life of me, I can't figure out why though. But I at least have an idea of where they tend to go and when."

        scene bg compound with fade

        "This predictably leads me to the old manor they are operating out of. Realizing that the building across the street is empty, I force my way in and set myself up to keep watch." 
        
        "I take notes on the comings and goings of its raincoat occupants, but it's hard to make out any more than that. Furthermore, whenever I try to compare my notes with the book, it is already updated." 
    ...
    scene bg street with fade
    show rainmidheavy zorder 5
    show rainbackheavy zorder 15
    show rainfront onlayer front
    ...
    "Though the streets are still flooded, I end up stopping for coffee at a local cafe. At first I'm just surprised it is open at all, but when I lock eyes with the person behind the counter, I feel a piercing sense of dread." 
        
    "Is the barista with 'them'? I don't see a raincoat on them, but that doesn't mean anything. And what about the other customers? I can feel them looking at me. Staring. Do they know something? Are they plotting something?"

    "Before the situation can escalate any further, I leave money on the counter and sprint out the door. I can't take any more chances." 
        
    "I don't know who I can trust. Or if I can't trust anyone. I need to take action. I need to figure out what they are planning and stop it."

    if getrest:
        show bg street with fade
        stop music fadeout 0.5
        play music "audio/4 Lovecraftian/4B/2 For Wandering The Desolate Streets L.ogg" loop fadein 0.5
        show rainmidheavy zorder 5
        show rainbackheavy zorder 15
        show rainfront onlayer front
        play nature "audio/Ambient/rain4.ogg" loop fadein 1.0
        ...
        "I end up taking a more winding path, just in case someone really did follow me from the cafe. It's funny, I'm pretty sure I've been this way before but I can hardly recognize anything at all." 
        
        "I should have passed by a grocery store and a pharmacy by now. Yet there are hardly any buildings now."
        ...
        hide rainfront onlayer front 
        stop music fadeout 0.35
        play music "audio/4 Lovecraftian/3B/2 Cult Lore Dump, Unveiling Mystery Track L.ogg" loop fadein 0.25

        "I trudge ahead and peek through the doors. I think the librarian at the front desk had a yellow raincoat last time. While I can see the coat still draped on the chair, it's hard to tell for sure if it's 'one of those' raincoats." 
        
        "And more importantly they are seemingly preoccupied with their phone, swinging it to and fro in the telltale dance of trying to get a signal."
        ...
        "I chuckle, allowing myself a brief respite before manically going over everything I've collected thus far. It takes me a good few hours to piece everything together, and by the end of it, Shiori's book has several new pages that have started to resemble a conspiracy board." 
        
        "But more importantly, I've noticed a few things."

        stop music fadeout 0.5
        play music "audio/4 Lovecraftian/4B/1 When The City-Story Is Unraveling L.ogg" loop fadein 0.25

        "First of all, there are a lot of disappearances in this town. It traces back to its founding in the 1800s. Second is that symbol from the raincoats. I've found traces of it as well as other symbols of the Void Wyrm littered throughout odd pictures." 
        ...
        "The door creaks open and I am met with a plain and unassuming face with disarming features. Seemingly another student. Seemingly harmless. {i}Seemingly.{/i} Who would be here in this weather? Plus there should be plenty of other study rooms. Why this one, why mine?!"

        qs "Oh. Sorry. Are you using this room?"

        "Our eyes meet as I try to discern their intentions. However, their eyes drift towards the desk, still partially cluttered with research I had undertaken." 
        
        "When their eyes finally move towards Shiori's book, I wind up my arm and deliver a uniquely solid blow for someone of my athleticism. I don't waste time either, and I leap over their limp form, sprinting for the nearest exit."
    ...
    if exhaustion:
        ...
        "And while I'm not too familiar with this part of town, I feel like something is missing from it. Not that I would be able to place what is where."

        p_i "I have a cult to worry about, who cares if a couple things have moved around?"

        "With a better idea of when and where to expect cultists, it's a simple enough task to find a window that is relatively safe to enter from. And in an old place like this, it's actually pretty simple to pop the screen out of its frame and open it up." 
        ...
        show bg underhall with dissolve_slow
        ...
        image cultist1 = "images/lovecraft/cultist.png"
        image cultist2 = "images/lovecraft/cultist.png"
        image cultist3 = "images/lovecraft/cultist.png"

        show cultist1 at left
        with dissolve_fast
        show cultist2 at right
        with dissolve_fast
        show cultist3 at center
        with dissolve_fast
        

        "As I descend the stairs, I am greeted by the sounds of running water and the low hum of chanting. Not in any language I know but nonetheless familiar. I don't think they have noticed me yet, but I keep myself nimble just in case." 
        
        "It is nearly in vain as I spot a group of cultists in the room when I reach the bottom of the steps..."
        
        "I froze up. It is only due to the cultists' focus on the ritual that I continue to go unnoticed."
        ...
        "And nothing comes up. Not a soul, not a person, not even a body. Nothing ever comes up."
    ...
    play music "audio/4 Lovecraftian/2B/3 Study Room Conversation With Shiori L.ogg" loop fadein 0.5
    stop ambient fadeout 0.5
    play ambient "audio/Ambient/1 Subtrack L.ogg" fadein 0.5 loop
    play nature "audio/Ambient/rain4.ogg" fadein 0.5 loop

    "Not too far off, I spot another one of those 'unique' flowers. I have begun to associate them with Shiori for whatever reason. I begin walking towards it as it blinks at me in recognition. Or is it supposed to be a wink? It only has one eye." 
    
    "Much like the others, it sinks back into the ground, but this time another pops up in the distance. Realizing what these things are doing, I follow their lead. Behind me I can hear a ruckus, probably the consequences of my own actions, so I pick up my pace."
    ...
    "As far as I can tell, the cult has been around for about as long as the town has, performing rituals in secret and making people disappear. Every few decades they offer something to this 'Void Wyrm' to strengthen it." 
    
    "But they have always lacked something to unleash it upon our world. Something that only 'The Archiver' knows."

    p "So that's why they were after Shiori? Please tell me she's safe..."

    "But since they have Shiori, that means they are probably preparing the ritual to summon their god. This at least gives me an idea of where they will be. I pull myself up from the bench and start running." 
    
    "I try to pay it no mind as I charge right through empty street corners that I know had been home to convenience stores and pawnshops. My legs are killing me by the time I reach my destination."
    ...
    "I arrive at their compound and it feels… wrong. The torrential rain has more or less hit its peak, erupting into a furious storm, yet this place remains tranquil." 
    
    "It is awash with cultists moving things around, setting up chairs, booths and picnic blankets amongst the arcane sigils and ornate pillars."
    ...
    if grabcoat:
        ...
        stop music fadeout 0.5
        play music "audio/4 Lovecraftian/5B (Bad End)/1 Getting Caught At Ritual Site L.ogg" loop fadein 0.5
        ...
        "My eyes soon lock onto a familiar face: the front desk worker from the library! They're a part of this too?!" 
        
        "And more importantly they seem just as carefree with their coat as before. Hanging it over a nearby folding chair instead of wearing it properly."
        ...
        "As if to prove my point, I begin to hear shouts of distress behind me, so I quicken my pace and enter the building." 
        
        "There are a good number of people gathered here, but most of them are out back preparing for the ritual. Just in case, I grab a small box of supplies lying around to look busy."
    ...
    if callpolice:
        ...
        "Or at least that's what I tell myself. In all honesty I'm exhausted. Tired of playing detective and conspiracy theorist. I have enough evidence collected. All I need to do is get the police over here." 
        
        "I pick up the phone and fidget about, until I get a signal. What would get the police over here quickly, though? I dial the number, consider my options, and wait for someone to pick up."
        ...
        "The police do in fact, show up, sirens blaring and everything. However, they step out of the vehicle wearing bright yellow raincoats."
        ...
        "Jumping through a window isn't like in movies. It's always dangerous and could get you seriously injured." 
        
        "However, as I brace myself for the piercing sensation of glass striking my fleshy body, it instead clatters harmlessly against me and scatters across the floor."

        show bg culthall with slideright
